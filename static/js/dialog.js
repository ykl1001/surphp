...
artDialog.fn = artDialog.prototype = {
	...
	content: function (msg,url) {
		var prev, next, parent, display,
			...
			height = wrap.offsetHeight,// fix ie7 by 20130625
			left = parseInt(wrap.style.left != '' ? wrap.style.left : 100),
			top = parseInt(wrap.style.top != '' ? wrap.style.top: 100),
			...
			if (isIframe) {
				if (typeof _hash == 'string') url += (url.indexOf('?') > -1 ? '&': '?') + '_hash=' + _hash;
