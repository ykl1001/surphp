function att_show(serverData,file)
{
	...
	if(ext == 1) {
		...
		var img = '<a href="javascript:;" onclick="javascript:att_cancel(this,'+id+',\'upload\')" class="on"><div class="icon"></div><img src="/static/image/ext/'+ext+'.png" width="80" imgid="'+id+'" path="'+src+'" title="'+filename+'"/></a>';
	}
	$.get('/index.php?m=attachment&c=index&a=swfupload_json&aid='+id+'&src='+src+'&filename='+filename);
