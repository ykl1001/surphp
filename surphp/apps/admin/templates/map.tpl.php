...
<?php $menus = Menu::admin_menu($r['id']);foreach ($menus as $s=>$r):?>
<li><a href="javascript:go('index.php?m=<?php echo $r['m']?>&c=<?php echo $r['c']?>&a=<?php echo $r['a']?>&_hash=<?php echo $_SESSION['_hash']?>&menuid=<?php echo $r['id']?><?php echo isset($r['data']) ? $r['data'] : ''?>')"><?php echo L($r['name'])?></a></li>
