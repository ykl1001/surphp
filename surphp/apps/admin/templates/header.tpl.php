...
<script language="javascript" type="text/javascript" src="<?php echo JS_PATH?>dialog.js?v=1.0"></script>
<?php } ?>
	...
	<?php if(!isset($show_pc_hash)) { ?>
		...
		for(var i=0;i<num;i++) {
			...
			if(href && href.indexOf('javascript:') == -1) {
				if(href.indexOf('?') != -1) {
					html_a[i].href = href+'&_hash='+_hash;
				} else {
					html_a[i].href = href+'?_hash='+_hash;
				}
			}
...
<div class="subnav">
    ...
    <?php echo Menu::submenu($_GET['menuid'],$big_menu); ?>
    </div>
</div>
<?php } ?>
<style type="text/css">
