...
<form action="index.php?m=attachment&c=address&a=update&_hash=<?php echo $_SESSION['_hash'];?>" method="post" onsubmit="return confirm('<?php echo L('form_submit_confirm');?>')">
