...
$LANG['apply'] = '应用';
$LANG['apply_list'] = '应用';
$LANG['play_admin_list'] = '玩玩';
$LANG['newsletter_admin_list'] = 'Newsletter';
$LANG['edit_1'] = '修改栏目';
...
$LANG['content_copy'] = '批量复制';
$LANG['comment_del'] = '删除评论';
$LANG['schedule'] = '时装周日程';
$LANG['addschedule'] = '新增日程';
$LANG['special_type'] = '时装周管理';
$LANG['schedule'] = '时装周日程';
$LANG['addschedule'] = '新增日程';
$LANG['special_type'] = '时装周管理';
$LANG['schedule_type'] = '时装周管理';
$LANG['trial'] = '试用中心';
$LANG['trial'] = '应用';
$LANG['interested'] = '感兴趣列表';
$LANG['report'] = '报告列表';
$LANG['trial_apply'] = '应用';
$LANG['trial_interested'] = '感兴趣列表';
$LANG['trial_report'] = '报告列表';
$LANG['schedule_setting'] = '时装周设置';
$LANG['beautyvoice'] = '美妆评分';
$LANG['setting'] = '设置';
$LANG['beauty_seting'] = '设置';
$LANG['tags'] = '热门标签';
$LANG['cover_admin_list'] = '封面投票';
?>